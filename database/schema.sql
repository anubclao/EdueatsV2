-- ============================================================
--  EduEats — Script completo de base de datos MySQL
--  Base de datos: edueat
-- ============================================================

CREATE DATABASE IF NOT EXISTS edueat
...
-- Users (Super Admin + cuentas de prueba)
...
INSERT IGNORE INTO recipes (id, name, description, category, calories, image_url) VALUES
  ...
  ('2',  'Ensalada César',           'Clásica con crutones, parmesano y aderezo especial',           'starter',    180, '/images/starter/2.jpg'),
  ('3',  'Pollo a la Parrilla',      'Pechuga marinada con hierbas finas y limón',                  'main',       450, '/images/main/3.jpg'),
  ('4',  'Espagueti Boloñesa',       'Pasta al dente con salsa de carne casera italiana',            'main',       550, '/images/main/4.jpg'),
  ('v1', 'Hamburguesa de Lentejas',  'Opción vegetariana rica en proteína con pan integral',         'vegetarian', 380, '/images/vegetarian/v1.jpg'),
  ('v2', 'Bowl de Quinoa y Vegetales','Mix nutritivo con aguacate y vinagreta de limón',             'vegetarian', 320, '/images/vegetarian/v2.jpg'),
  ...
  ('8',  'Yogur Griego',             'Cremosidad natural con miel orgánica y granola crujiente',    'snack',      120, '/images/snack/8.jpg'),
  ('9',  'Barrita de Cereal',        'Energía saludable con avena, miel y frutos secos',            'snack',      180, '/images/snack/9.jpg');

...
--  Esto convierte todas las tablas a utf8mb4_unicode_ci para
--  evitar el error "Illegal mix of collations".
-- ============================================================
...
-- Tablas de autenticación (creadas automáticamente por la API)

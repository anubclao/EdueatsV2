...
function resolveSessionSecret() {
    ...
    if (!secret) {
        if (isProduction) {
            ...
            throw new Error('[Sessions] SESSION_SECRET es obligatorio en producción. ' +
        ...
        console.warn('[Sessions] AVISO: SESSION_SECRET no está definido. Usando un secret solo-para-desarrollo. ' +

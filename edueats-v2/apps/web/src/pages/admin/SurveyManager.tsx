...
export const SurveyManager = () => {
  ...
  const getWhatsAppLink = (phone: string, userName: string) => {
    ...
    const msg = encodeURIComponent(`Hola ${userName}, somos del equipo de EduEats. Nos comunicamos en relación a tu PQR registrada. ¿Cómo podemos ayudarte?`);
  ...
  const getTypeLabel = (type: string) => {
    const map: Record<string, string> = {
      suggestion: 'Sugerencia', complaint: 'Queja', claim: 'Reclamo', congratulation: 'Felicitación'
    };
